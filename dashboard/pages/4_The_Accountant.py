"""
4_The_Accountant.py — bio + full betting history for The Accountant.
"""
...
with get_connection() as conn:
    render_profile(conn, SPORT, BOT_KEY, DISPLAY_NAME, ACCENT, key_prefix='bio_accountant')
